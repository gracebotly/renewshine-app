...
export const DEFAULT_DOCUMENTS: Record<string, MessageDocument> = {
  ...
  'invoice:email': {
    ...
    blocks: [
      { id: 'heading', type: 'heading', text: 'Invoice {{invoiceNumber}}' },
      { id: 'p1', type: 'paragraph', text: 'Hi {{firstName}},' },
      {
        id: 'p2',
        type: 'paragraph',
        text: 'Thank you for choosing RenewShine. Your invoice is below.',
      },
      {
        id: 'meta',
        type: 'paragraph',
      ...
      { id: 'notes', type: 'paragraph', text: '{{notes}}' },
      {
        id: 'pay',
        type: 'button',
        label: 'Pay Invoice',
      ...
      { id: 'sig', type: 'paragraph', text: 'RenewShine' },
    ],
  },
  'invoice:sms': {
    channel: 'sms',
