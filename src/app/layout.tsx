      ...
      <body className="min-h-full flex flex-col">
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({ '@context': 'https://schema.org', '@type': 'HomeAndConstructionBusiness', name: 'RenewShine', url: 'https://renewshine.co', logo: 'https://renewshine.co/logo-primary.svg', image: 'https://renewshine.co/og-image.png', description: 'Premium residential cleaning service in Washington DC, Maryland, and Northern Virginia. Photo-reviewed quotes — confirmed price before you pay.', telephone: '+13024927197', email: 'hello@renewshine.co', priceRange: '$$', areaServed: [ { '@type': 'City', name: 'Washington, DC' }, { '@type': 'City', name: 'Arlington, VA' }, { '@type': 'City', name: 'Alexandria, VA' }, { '@type': 'City', name: 'Bethesda, MD' }, { '@type': 'City', name: 'Silver Spring, MD' }, { '@type': 'City', name: 'McLean, VA' }, { '@type': 'City', name: 'Potomac, MD' }, { '@type': 'City', name: 'Rockville, MD' }, { '@type': 'City', name: 'Gaithersburg, MD' }, { '@type': 'City', name: 'Reston, VA' } ], hasOfferCatalog: { '@type': 'OfferCatalog', name: 'Cleaning Services', itemListElement: [ { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Standard House Cleaning' } }, { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Deep Cleaning Service' } }, { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Move-Out Cleaning' } }, { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Move-In Cleaning' } }, { '@type': 'Offer', itemOffered: { '@type': 'Service', name: 'Post-Construction Cleaning' } } ] }, sameAs: [] }).replace(/</g, '\u003c'),
          }}
        />
        <Navbar />
